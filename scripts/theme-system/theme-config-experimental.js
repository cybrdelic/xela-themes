...
export const experimentalThemes = [
  {
    ...
    roles: {
      ...
      overlay: '#0E1012E6',
      backdrop: '#00000099',
      border: 'transparent', // fully transparent for true borderless UI
  ...
  },
  {
    ...
    roles: {
      ...
      accentSelection: withAlpha('#3366FF',0.17),
      accentLink: '#3366FF'
    },
    tokens(c){
      return {
  ...
  },
  {
    ...
    roles: {
      ...
      accentSelection: withAlpha('#A05CFF',0.2),
      accentLink: '#5AAEFF'
    },
    tokens(c){
      return {
  ...
  },
  {
    ...
    roles: {
      ...
      accentSelection: withAlpha('#00C0FF',0.2),
      accentLink: '#41D1FF'
    },
    tokens(c){
      return {
    ...
    htmlScheme: {
      htmlTag: '#00C0FF', htmlStructureTag: '#41D1FF', htmlInlineTag: '#33B58C', htmlScriptTag: '#FFA341',
      htmlAttribute: '#41D1FF', htmlClassAttribute: '#33B58C', htmlIdAttribute: '#00C0FF', htmlStyleAttribute: '#33B58C', htmlEventAttribute: '#FFA341',
      htmlAttributeValue: '#33B58C', htmlAttributeValueString: '#41D1FF', htmlTagBrackets: '#8A959C', htmlPunctuation: '#607078', htmlStringPunctuation: '#8A959C', htmlComment: '#607078', htmlEntity: '#FFA341', htmlEntityPunctuation: '#00C0FF', htmlDoctype: '#FF5B55', embeddedCss: '#33B58C', embeddedCssBlock: '#00C0FF', embeddedJs: '#FFA341', embeddedJsBlock: '#41D1FF', htmlFormTag: '#33B58C', htmlFormAttribute: '#41D1FF', htmlTableTag: '#00C0FF', htmlMediaTag: '#FFA341', htmlLinkTag: '#41D1FF', htmlHrefAttribute: '#33B58C', htmlSemanticTag: '#33B58C', htmlText: '#E3E8EC'
    }
  },
  {
    ...
    roles: {
      ...
      accentSelection: withAlpha('#9A5F1E',0.18),
      accentLink: '#376E78'
    },
    tokens(c){
      return {
  ...
  },
  {
    ...
    roles: {
      ...
      accentSelection: withAlpha('#146FD4',0.2),
      accentLink: '#146FD4'
    },
    tokens(c){
      return {
    ...
    htmlScheme: {
      htmlTag: '#146FD4', htmlStructureTag: '#2B87EB', htmlInlineTag: '#299F5D', htmlScriptTag: '#FFB652',
      htmlAttribute: '#2B87EB', htmlClassAttribute: '#299F5D', htmlIdAttribute: '#146FD4', htmlStyleAttribute: '#299F5D', htmlEventAttribute: '#FFB652',
      htmlAttributeValue: '#299F5D', htmlAttributeValueString: '#2B87EB', htmlTagBrackets: '#6C7B87', htmlPunctuation: '#8897A3', htmlStringPunctuation: '#6C7B87', htmlComment: '#8897A3', htmlEntity: '#FFB652', htmlEntityPunctuation: '#146FD4', htmlDoctype: '#F0625F', embeddedCss: '#299F5D', embeddedCssBlock: '#146FD4', embeddedJs: '#FFB652', embeddedJsBlock: '#2B87EB', htmlFormTag: '#299F5D', htmlFormAttribute: '#2B87EB', htmlTableTag: '#146FD4', htmlMediaTag: '#FFB652', htmlLinkTag: '#2B87EB', htmlHrefAttribute: '#299F5D', htmlSemanticTag: '#299F5D', htmlText: '#1D2730'
    }
  }
];
